        ...
        <DialogContent>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {!! $t('This action cannot be undone. This will permanently delete the team ":name".', ['name' => '<strong>' . props.team.name . '</strong>']) !!}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div class="space-y-4 py-4">
                    <div class="grid gap-2">
                        <Label for="confirmation-name">
                            {!! $t('Type ":name" to confirm', ['name' => '<strong>' . props.team.name . '</strong>']) !!}
                        </Label>
                        <Input
